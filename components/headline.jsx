      ...
      <div className={styles.headlineContainer}>
        ...
        >
          ...
          <div className={`${styles.mainContent} mainContent`}>
            ...
            <div
              className={`${styles.main1himage} ${styles.articleContainer} main1himage`}
            >
            ...
            <div
              className={`${styles.main2h} ${styles.articleContainer} ${styles.main2h2} main2h`}
            >
              <div className={`${styles.main2htitle} main2htitle`}>
            ...
            <div
              className={`${styles.main3h} ${styles.articleContainer} ${styles.main3h2} main3h`}
            >
              <div className={`${styles.main3htitle} main3htitle`}>
                <h3>
