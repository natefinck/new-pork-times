  ...
  return (
    <>
        ...
        <div className={`${styles.header} header`}>
          <Link href="/">
            <div className={`${styles.logoContainer} logoContainer`}>
              <Image alt="The New Pork Times Logo" src={logo}></Image>
            </div>
          </Link>
          <div
            className={`${styles.navContainer} navContainer`}
      ...
      <style jsx>{`
        .navContainer {
          box-shadow: ${menuOpen
            ? "0px 0px 16px 2px black"
            : "0px 0px 0px 0px black"};
          transform: ${menuOpen ? "translateX(0%)" : "translateX(-100%)"};
          transition: ${menuOpen
            ? "all .3s cubic-bezier(0, 0.65, 0.58, 1)"
            : "all .25s cubic-bezier(0.68, -0.06, 0.48, 0.99)"};
        }
